...
public class ShouldOpenProductPageWithCorrectProductOnProductShortCardImageClickTest extends MainPageBaseTest{
    ...
    public void actAndAssert(){
        //act
        ProductPage productPage = mainPage.leaderProducts.get(leaderProductIndex).clickImageLink();
        //assert
